...
public class MainActivity2 extends AppCompatActivity {
    ...
    private final String appKey = "36e847094c836";
    private final String appSecret = "dfe8f0b4fe1c9c36b01e4fa12256cb69";
    ...
    private Handler handler=new Handler(Looper.myLooper()) {
        public void handleMessage(Message msg) {
            switch (msg.arg1) {
                case 0://客户端验证成功，可以进行注册,返回校验的手机和国家代码phone/country
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt_getCode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(phone.equals("")){
                    Toast.makeText(MainActivity2.this,"手机号不能为空",Toast.LENGTH_SHORT).show();
                }else{
                    //填写了手机号码
                    if(isMobileNO(phone)){
                        //如果手机号码无误，则发送验证请求
                        ...
                        //手机号格式有误
                        Toast.makeText(MainActivity2.this,"手机号格式错误，请检查",Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
        ...
        bt_vertify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (code.equals("")){
                    Toast.makeText(MainActivity2.this,"验证码不能为空",Toast.LENGTH_SHORT).show();
                }else{
                    //填写了验证码，进行验证
